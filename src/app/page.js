...
function Home() {
  return (
    <>
      <ArcherContainerWrapper strokeColor="gray"
        noCurves
        offset={10}
        endMarker={false}
      >
        <div className={`
          grid justify-items-center gap-48 lg:grid-cols-2 lg:gap-0
        `}
        >
          <section className={`
            container col-span-full mt-20 flex min-h-[calc(100svh-80px-5rem)]
            flex-col gap-48 text-center lg:flex-row lg:gap-0 lg:pb-20
          `}
          >
            <article>
              <div className={`flex flex-col items-center gap-16`}>
                <div>
                  <h1 className={`
                    mb-4 text-balance text-center text-5xl font-bold
                  `}
                  >
                ...
                <div>
                  <div className={`
                    flex aspect-video w-72 items-center justify-center
                    bg-neutral-400
                  `}
                  >
                    <p>Nyeste projekt</p>
            ...
            <article className="lg:place-self-end">
              <div className={`flex flex-col items-center justify-center`}>
                ...
                >
                  <h2 className={`
                    mx-auto mb-16 w-fit bg-neutral-400 px-4 py-2 text-5xl
                    font-thin italic
                  `}
                  >
                    Introduktion
                ...
                <ArcherElementWrapper id="intro-text"
                  relations={[
                    {
